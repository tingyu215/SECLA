...
parser.add_argument("--out_dir", type=str, default="/face_naming/unsup_frag")
...
def train_epoch(model, loss_type, frag_loss, global_loss, train_dataloader, optimizer, scheduler):
    ...
    for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
        face_emb, ner_ids, word_emb = batch["face_emb"], batch["ner_ids"], batch["word_emb"]
        ...
        if args.fine_tune is True:
            ...
            face_j, ner_j = model(face_emb.squeeze(1).cuda(), ner_ids.squeeze(1).cuda())
...
if __name__ == "__main__":
    ...
    out_file_name = "word_{}_{}_{}-proj_dim:{}_bias{}_{}data:{}_loss:{}-{}-{}-{}-{}_bsz:{}_shuffle-{}_epoch{}_op:{}_lr{}_noname{}_{}_textModel{}_finetune-{}_mean-{}-{}-layerS{}".format(args.model_name,
             args.dict_name[-10:-5],
             args.proj_type,
             args.proj_dim,
             args.add_bias,
