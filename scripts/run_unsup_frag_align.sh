#!/bin/sh
python /FaceNaming/unsup_fragment_align.py --sys_dir /FaceNaming \
--out_dir /OUTPUTDIR/face_naming/unsup_frag \
...
--num_epoch 60 --train_batch_size 20 --val_batch_size 32 --test_batch_size 1 \
--shuffle True \
...
--agree_type diag --max_type normal --use_onehot False --no_facenet True
