...
parser.add_argument("--out_dir", type=str, default="/export/home1/NoCsBack/working/tingyu/face_naming/unsup_frag")
parser.add_argument("--dict_name", type=str, default="gt_dict_cleaned_phi_face_name.json")
...
parser.add_argument("--loss_type", type=str, default="batch")
parser.add_argument("--alpha", type=float, default=0.15)
parser.add_argument("--direction", type=str, default="agree")
...
parser.add_argument("--data_type", type=str, default="no_train")
...
parser.add_argument("--use_name_ner", type=str, default="name")
parser.add_argument("--add_noname", default=True, type=lambda x: (str(x).lower() == 'true'))
parser.add_argument("--cons_noname", default=True, type=lambda x: (str(x).lower() == 'true'))

parser.add_argument("--add_bias", default=True, type=lambda x: (str(x).lower() == 'true'))
...
parser.add_argument("--use_mean", default=True, type=lambda x: (str(x).lower() == 'true'))
...
parser.add_argument("--no_facenet", default=False, type=lambda x: (str(x).lower() == 'true'))
...
if __name__ == "__main__":
    ...
    out_file_name = "{}_{}_{}-proj_dim:{}_bias{}_{}data:{}_loss:{}-{}-{}-{}-{}_bsz:{}_shuffle-{}_epoch{}_op:{}_lr{}_noname{}_{}_textModel{}_finetune-{}_mean-{}-{}-layerS{}-{}-{}".format(args.model_name,
             args.dict_name[-10:-5],
             args.proj_type,
             args.proj_dim,
             args.add_bias,
    ...
    if args.no_facenet:
        ...
        facenet = torch.nn.Sequential(*list(resnet.children())[:-1])
    else:
